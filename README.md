...
[![Socket Badge](https://img.shields.io/endpoint?url=https://socket.dev/api/badge/npm/package/@_redsocs/spam-warden/latest)](https://socket.dev/npm/package/@_redsocs/spam-warden)
